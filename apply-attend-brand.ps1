# ============================================================
# ATTEND â€” QUIET EMERALD FRONTEND
# ============================================================
#
...
Write-Host " ATTEND â€” QUIET EMERALD BRAND BUILD" -ForegroundColor DarkGreen
Write-Host "==============================================" -ForegroundColor DarkGreen
Write-Host ""
...
<html lang="en">
  ...
  <head>
    ...
    <meta
      name="description"
      content="Attend â€” make time intentional."
    />
    ...
    <title>attend. â€” Make time intentional.</title>
...
Write-Host "  Playfair Display â€” brand / editorial"
Write-Host "  Inter            â€” application UI"
Write-Host ""
